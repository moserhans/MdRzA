...
class woche(models.Model):
	...
	mo = models.NullBooleanField(default=False)
	di = models.NullBooleanField(default=False)
	mi = models.NullBooleanField(default=False)
	do = models.NullBooleanField(default=False)
	fr = models.NullBooleanField(default=False)
